      ...
      <div className="aboutme-contact">
        <div className="aboutme-container04">
          ...
          <div className="aboutme-info">
            <div className="aboutme-container07">
              ...
              <div className="aboutme-container08">
                <div className="aboutme-container09">
                  ...
                  <a href="tel:+40 772 100 200" className="aboutme-link small">
                    (+40) 772 100 200
                  </a>
                </div>
                <div className="aboutme-container10">
                  <svg viewBox="0 0 1024 1024" className="aboutme-icon02">
                    <path d="M854 342v-86l-342 214-342-214v86l342 212zM854 170q34 0 59 26t25 60v512q0 34-25 60t-59 26h-684q-34 0-59-26t-25-60v-512q0-34 25-60t59-26h684z"></path>
                  </svg>
                  <a
                    href="mailto:hello@creative-tim.com?subject="
                    className="aboutme-link1 small"
                  >
                    hello@creative-tim.com
                  </a>
                </div>
                <div className="aboutme-container11">
                  <svg viewBox="0 0 1024 1024" className="aboutme-icon04">
                    <path d="M512 490q44 0 75-31t31-75-31-75-75-31-75 31-31 75 31 75 75 31zM512 86q124 0 211 87t87 211q0 62-31 142t-75 150-87 131-73 97l-32 34q-12-14-32-37t-72-92-91-134-71-147-32-144q0-124 87-211t211-87z"></path>
                  </svg>
                  <span className="aboutme-text21 small">
                    Dyonisie Wolf Bucharest, RO 010458
                  </span>
                </div>
              </div>
              <div className="aboutme-container12">
                <svg
                  viewBox="0 0 877.7142857142857 1024"
                  className="aboutme-icon06"
                >
                  <path d="M713.143 73.143c90.857 0 164.571 73.714 164.571 164.571v548.571c0 90.857-73.714 164.571-164.571 164.571h-107.429v-340h113.714l17.143-132.571h-130.857v-84.571c0-38.286 10.286-64 65.714-64l69.714-0.571v-118.286c-12-1.714-53.714-5.143-101.714-5.143-101.143 0-170.857 61.714-170.857 174.857v97.714h-114.286v132.571h114.286v340h-304c-90.857 0-164.571-73.714-164.571-164.571v-548.571c0-90.857 73.714-164.571 164.571-164.571h548.571z"></path>
                </svg>
                <svg
                  viewBox="0 0 950.8571428571428 1024"
                  className="aboutme-icon08"
                >
            ...
            />
            <div className="aboutme-container13"></div>
          </div>
        </div>
      </div>
      <Footer></Footer>
